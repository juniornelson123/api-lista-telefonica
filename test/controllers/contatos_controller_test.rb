...
class ContatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post contatos_url, params: { contato: { date: @contato.date, nome: @contato.nome, operadora_id: @contato.operadora_id, telefone: @contato.telefone } }
    end
  ...
  test "should update contato" do
    patch contato_url(@contato), params: { contato: { date: @contato.date, nome: @contato.nome, operadora_id: @contato.operadora_id, telefone: @contato.telefone } }
